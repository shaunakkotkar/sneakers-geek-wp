...
{
    const DEFAULT_MAXIMUM_AMOUNT = 4500;
    const DEFAULT_MINIMUM_AMOUNT = 1500;
    const DEFAULT_PAYMENT_DESCRIPTION = 'Pay with your Cashalo via <strong>Xendit</strong>';
